...
int main() {
	...
	senLength = strleng(senString);
	serLength = strleng(serString);
	repLength = strleng(repString);
	...
	destString[l1] = '\0';
	printf("The String has %d Occurances.\n", count);
	printf("The Resultant String is : %s", destString);
	return 0;
}